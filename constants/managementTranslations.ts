...
export const MANAGEMENT_TRANSLATIONS = {
    ...
    'mod_name_QUEUE_MANAGER': { zh: '排队叫号', my: 'တန်းစီခြင်း စီမံခန့်ခွဲမှု' },
    ...
    'mod_name_ATTENDANCE_CONSOLE': { zh: '考勤管理', my: 'တက်ရောက်မှုစစ်ဆေးရေး ထိန်းချုပ်ခန်း' },
    ...
    'mod_name_PROCUREMENT': { zh: '采购订货', my: 'စမတ် ကုန်ပစ္စည်း မှာယူခြင်း' },
    ...
    'mod_name_ASSESSMENT': { zh: '技能评估', my: 'ဝန်ထမ်းစွမ်းဆောင်ရည် ဆန်းစစ်ခြင်း' },
    ...
    'mod_name_SELF_INVOICE': { zh: '自开凭单', my: 'ကိုယ်တိုင်ထုတ် ပြေစာများ ရေးဆွဲပြုလုပ်ခြင်း' },
    'mod_desc_SELF_INVOICE': { zh: '生成与自制支出凭证', my: 'အသုံးစရိတ် ပြေစာအထောက်အထားများ ဖန်တီးပြုလုပ်ခြင်း' },
    'mod_name_KITCHEN_ALERT': { zh: '厨房通知', my: 'မီးဖိုချောင်သတိပေးချက်' },
